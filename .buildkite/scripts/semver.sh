...
# This script was copied from https://github.com/fsaintjacques/semver-tool/blob/master/src/semver
# Any modifications are a result of running it through shfmt
